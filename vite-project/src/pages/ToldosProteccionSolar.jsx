  ...
  return (
    <Page>
      ...
      <ServiceHero
        ...
        title={
          <>
            Toldos en <span>Castellón</span> & protección solar a medida
          </>
        }
        subtitle="Instalamos toldos a medida para terrazas, balcones, jardines y negocios, con soluciones pensadas para mejorar la sombra, el confort y la estética de cada espacio."
        hero480={hero_480}
        hero768={hero_768}
        hero1280={hero_1280}
        hero1920={hero_1920}
      ...
      <Section id="tipos">
        <SectionInner>
          <IntroHeader>
            ...
            <IntroText>
              Te ayudamos a elegir el toldo más adecuado para tu terraza,
              balcón, jardín o negocio, según la orientación, el uso del espacio
              y la protección solar que necesitas.
            </IntroText>
          </IntroHeader>
      ...
      <AutomationCTA aria-label="CTA automatización">
        <AutomationCTAInner>
          ...
          <AutomationLeft>
            ...
            <AutomationProof>
              Motores, sensores, control por app · Instalación profesional en
              Castellón
            </AutomationProof>
          </AutomationLeft>
          <AutomationRight>
